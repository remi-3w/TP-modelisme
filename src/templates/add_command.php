...
<h2><i class="far fa-save"></i> Enregistrement d'une nouvelle commande</h2>
...
<form class="generic-form" action="add.php" method="post">
    <fieldset>
        <legend><i class="fa fa-shopping-cart"></i> Nouveau bon de commande</legend>
            <ul>
                <li>
                ...
                <li>
                    ...
                    <input id="quantite" name="quantité" >
                </li>
                <li>
